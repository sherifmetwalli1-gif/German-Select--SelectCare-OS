    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .quick-access-pill {
            ...
            gap: 6px;
            padding: 8px 16px;
            background: linear-gradient(135deg, #D4A843 0%, #E8C158 100%);
            color: #001F3F;
            font-size: 12px;
            font-weight: 700;
        ...
        .quick-access-pill i { font-size: 14px; }
        ...
        .quick-access-pill:active { transform: scale(0.98); }
        ...
        .nav-item span { white-space: nowrap; letter-spacing: 0.2px; }
        ...
        .nav-item.active::after {
            ...
            width: 16px;
            height: 3px;
            background: linear-gradient(90deg, #D4A843, #E8C158);
        ...
        .floating-connect {
            ...
            width: 56px;
            height: 56px;
            background: linear-gradient(135deg, #D4A843, #E8C158);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .page-content, main { padding-bottom: 120px !important; }
        
        /* Responsive */
        @media (max-width: 360px) {
            .nav-item { padding: 5px 8px; min-width: 46px; }
            .nav-item i { font-size: 18px; }
            .nav-item span { font-size: 9px; }
            .quick-access-pill { padding: 6px 12px; font-size: 11px; }
            .floating-connect { width: 50px; height: 50px; font-size: 20px; bottom: 130px; }
            .floating-emergency { width: 44px; height: 44px; font-size: 16px; bottom: 130px; }
        }
        
        @media (min-width: 768px) {
            .quick-access-bar { bottom: 75px; padding: 10px 24px 6px; gap: 16px; }
            .quick-access-pill { padding: 10px 20px; font-size: 13px; }
            .bottom-nav {
            ...
            .bottom-nav-container { max-width: 600px; padding: 0 16px; }
            .nav-item {
                flex-direction: row;
                gap: 8px;
                padding: 10px 18px;
            ...
            .nav-item:hover { color: #FFFFFF; background: rgba(212, 168, 67, 0.2); }
            .nav-item:hover i { color: #E8C158; }
            .nav-item.active {
                color: #001F3F;
                background: linear-gradient(135deg, #D4A843 0%, #E8C158 100%);
                box-shadow: 0 4px 12px rgba(212, 168, 67, 0.35);
            }
            .nav-item.active i { color: #001F3F; filter: none; }
            .nav-item.active::after { display: none; }
            .nav-item .live-dot { border-color: #003366; }
            .floating-connect { bottom: 150px; right: 24px; width: 64px; height: 64px; font-size: 26px; }
            .floating-emergency { bottom: 150px; left: 24px; width: 54px; height: 54px; font-size: 20px; }
        }
        
        @media (min-width: 1024px) {
            .quick-access-bar { gap: 20px; }
            .quick-access-pill { padding: 10px 24px; font-size: 13px; }
            .bottom-nav-container { max-width: 700px; }
            .nav-item { padding: 10px 22px; font-size: 13px; }
        }
...
<body class="bg-cream">
    ...
    <!-- Bottom Navigation - Enhanced v3.0 -->
    <nav class="bottom-nav" role="navigation" aria-label="Main navigation">
        <div class="bottom-nav-container">
            ...
            <a href="/dashboard" class="nav-item ${activeNav === 'dashboard' ? 'active' : ''}" aria-label="Dashboard">
            ...
            <a href="/doctors" class="nav-item ${activeNav === 'doctors' ? 'active' : ''}" aria-label="Doctors">
