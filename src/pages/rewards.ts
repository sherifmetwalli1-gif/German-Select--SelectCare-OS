...
<body>
    ...
    <header class="bg-navy px-5 pt-12 pb-8">
        <div class="flex justify-between items-start mb-6">
            ...
            <div class="text-right">
                <span class="tier-badge tier-gold">GOLD MEMBER</span>
            </div>
        </div>
        
        <div class="text-center">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-gold/20 rounded-full mb-4">
                <i class="fas fa-coins text-gold text-4xl"></i>
            </div>
            <h1 class="text-white text-lg mb-1">Your SelectPoints</h1>
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-2 px-4 z-40">
        <div class="flex justify-around items-center max-w-md mx-auto">
            ...
            <a href="/daily-wellness" class="flex flex-col items-center py-2 px-3 text-gray-400 hover:text-gray-600 transition-colors">
            ...
            <a href="/rewards" class="flex flex-col items-center py-2 px-3 text-yellow-600">
